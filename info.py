...
API_ID = int(environ.get('API_ID', '22068414'))
API_HASH = environ.get('API_HASH', 'a49b5fd11943b79a1d914b9adc6bd8b1')
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '1580183981').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002100177484').split()]
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://naskarjaydeb67:xkVIeay8d5mZ9WzH@cluster0.axngcss.mongodb.net/?retryWrites=true&w=majority")
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1001995725897'))
...
URL = "https://stream-and-download-bot.onrender.com".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://stream-and-download-bot.onrender.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://stream-and-download-bot.onrender.com/".format(FQDN)
else:
    URL = "https://stream-and-download-bot.onrender.com/".format(FQDN)
